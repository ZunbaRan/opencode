/**
 * Built-in skill body: full generative-widget design guidelines (on-demand).
 * Adapted from CodePilot/Claude generative UI design guidance for OpenChamber.
 */
export const GENERATIVE_WIDGET_GUIDELINES_SKILL_NAME = "generative-widget-guidelines"
